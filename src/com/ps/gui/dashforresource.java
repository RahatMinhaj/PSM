...
public class dashforresource extends javax.swing.JFrame {

    /**
     * Creates new form DashBoard2
     */
    public dashforresource() {
        initComponents();
...
//        ap.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dashforresource.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dashforresource().setVisible(true);
